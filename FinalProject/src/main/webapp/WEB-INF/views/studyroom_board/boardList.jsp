...
<body>
	...
	<section class="section overfree" style="padding: 30px 0px;">
		...
		<tr>
			<td colspan="6" align="right" id="buttonTab">
				<c:if test="${ !empty loginUser }">
					&nbsp; &nbsp; &nbsp;
				<button class="btn-gradient blue" style="margin-left: 80%;"  onclick="location.href='bInsertView.bo';">글쓰기</button>				
				</c:if>
			</td>
		</tr>
		<hr>
		...
		<tr>
			<td colspan="6" align="right" id="buttonTab">
				<button class="btn-gradient purple" style="margin-left: 50%;"  onclick="location.href='index.jsp';">메인으로</button>				
			</td>
		</tr>
		<br><br>

	...
	<form action="bInsert.bo" method="post">
		<table id="boardInsertTable" border="1">
			...
			<tr>
				<th>작성자</th>
				<td>
					<input type="text" name="bo_name" readonly value="${ loginUser.member_Name }" style="background: lightgrey;">
				</td>
			</tr>
			<tr>
				<th>내용</th>
			...
			<tr>
				<td colspan="2" align="center">
					<input class="btn-gradient blue" type="submit" value="등록 하기"> &nbsp;
					<c:url var="blist" value="bList.bo">
						<c:param name="page" value="${ page }"/>
					</c:url>
					<a href='${ blist }' class='btn-gradient purple'>목록으로</a>
				</td>
			</tr>
		</table>
	</form>

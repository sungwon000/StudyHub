...
public class Pagination {
	...
	public static PageInfo getPageInfo(int currentPage, int listCount) {
		...
		int bookLimit = 10; // 한 페이지에 보여질 게시글 갯수
		
		// * maxPage - 총 페이지 수
		// 목록 수가 123개이면 페이지 수는 13페이지임
		// 짜투리 목록이 최소 1개일 때, 1page로 처리하기 위해 0.9를 더함
		maxPage = (int)((double)listCount / bookLimit + 0.9);
		...
		pi = new PageInfo(currentPage, listCount, pageLimit, maxPage, startPage, endPage, bookLimit);
